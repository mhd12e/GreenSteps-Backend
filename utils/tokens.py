...
def create_email_verification_token(subject: str, expires_delta: timedelta):

    return create_token(subject, expires_delta, TOKEN_TYPE_EMAIL_VERIFY)
...
def verify_email_verification_token(token: str):
    ...
    return verify_token(token, TOKEN_TYPE_EMAIL_VERIFY)
